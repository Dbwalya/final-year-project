      ...
      <div className="home-container">
        ...
        <div className="product-variety-row">
          <div>
            <Link to="/games">
              <ProductVariety
                image="https://m.media-amazon.com/images/I/61bxKvTvi7L._AC_UY218_.jpg"
                name="Gaming Accessories"
                button="Gaming Accessories"
              />
            </Link>
            <Link to="television">
              <ProductVariety
                ...
                name="Gaming Accessories"
                button="Television Set"
              />
            </Link>
            <Link to="/laptop">
              <ProductVariety
                image="https://m.media-amazon.com/images/I/71StGaPWnPL._AC_UY218_.jpg"
                name="Gaming Accessories"
                button="Laptops"
              />
            </Link>
          ...
          <div>
            ...
            <Link to="/fashion">
              <ProductVariety
                image="https://i.pinimg.com/236x/b4/59/a2/b459a2b313cfe44ec5139080a07365a1.jpg"
                name="Gaming Accessories"
                button="Fashion Hub"
              />
            </Link>
            <Link to="mensclothing">
              <ProductVariety
                image="https://i.pinimg.com/236x/cf/cc/0d/cfcc0d30609564337c752ddb4b73fa5a.jpg"
                name="Gaming Accessories"
